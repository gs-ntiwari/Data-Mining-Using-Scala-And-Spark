...
object TimeUsage extends TimeUsageInterface {
  ...
  def classifiedColumns(columnNames: List[String]): (List[Column], List[Column], List[Column]) = {
    val primaryNeeds=columnNames.filter(str=>(str.startsWith("t01")||str.startsWith("t11")||str.startsWith("t03") || str.startsWith("t1801")||str.startsWith("t1803"))).map(str=> new Column(str))
    val workActivities = columnNames.filter(str=>(str.startsWith("t05")||str.startsWith("t1805"))).map(str=> new Column(str))
    val otherActivities=columnNames.filter(str => !(str.startsWith("t01")||str.startsWith("t11")||str.startsWith("t03") || str.startsWith("t1801")||str.startsWith("t1803") || str.startsWith("t05")||str.startsWith("t1805"))).map(str=> new Column(str))
    (primaryNeeds, workActivities, otherActivities)
  }
